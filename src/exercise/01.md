...
To create a controlled ocmponent, attached a value={} property to the input
whihc tracks the changes and updates them as they happen.

When passing a prop to a component you can create a new one by destructuring and
defining a default value for it without defining the prop on the component in
the parent. This is object initialization. You can also define the default value
on the prop in the parent component, both seem to work.
